...
public class SummarizationFileRequest {
  ...
  public SummarizationFileRequest language(@javax.annotation.Nonnull String language) {
  ...
  public SummarizationFileRequest url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public SummarizationFileRequest origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public SummarizationFileRequest originalName(@javax.annotation.Nullable String originalName) {
  ...
  public SummarizationFileRequest savingMode(@javax.annotation.Nullable FileSavingMode savingMode) {
  ...
  public SummarizationFileRequest outputFormat(@javax.annotation.Nonnull SupportedConversionsFormats outputFormat) {
  ...
  public SummarizationFileRequest summarizationDegree(@javax.annotation.Nullable DegreeEnum summarizationDegree) {
  ...
  public SummarizationFileRequest minLength(@javax.annotation.Nullable Integer minLength) {
  ...
  public SummarizationFileRequest detectLanguage(@javax.annotation.Nullable Boolean detectLanguage) {
  ...
  public SummarizationFileRequest format(@javax.annotation.Nullable SummarizationSupportedFormats format) {
    this.format = format;
    return this;
  }
  ...
  public void setFormat(@javax.annotation.Nullable SummarizationSupportedFormats format) {
    this.format = format;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, summarizationFileRequest.language) &&
        ...
        Objects.equals(this.detectLanguage, summarizationFileRequest.detectLanguage) &&
        Objects.equals(this.format, summarizationFileRequest.format);
  }

  @Override
  public int hashCode() {
    return Objects.hash(language, url, origin, originalName, savingMode, outputFormat, summarizationDegree, minLength, detectLanguage, format);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("language", "url", "origin", "originalName", "savingMode", "outputFormat", "summarizationDegree", "minLength", "detectLanguage", "format"));
