...
public class SummarizationTextRequest {
  ...
  public SummarizationTextRequest language(@javax.annotation.Nonnull String language) {
  ...
  public SummarizationTextRequest text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public SummarizationTextRequest texts(@javax.annotation.Nullable List<String> texts) {
    this.texts = texts;
    return this;
  }
  ...
  public SummarizationTextRequest origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public SummarizationTextRequest detectLanguage(@javax.annotation.Nullable Boolean detectLanguage) {
  ...
  public SummarizationTextRequest summarizationDegree(@javax.annotation.Nullable DegreeEnum summarizationDegree) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, summarizationTextRequest.language) &&
        ...
        Objects.equals(this.detectLanguage, summarizationTextRequest.detectLanguage) &&
        Objects.equals(this.summarizationDegree, summarizationTextRequest.summarizationDegree);
  }

  @Override
  public int hashCode() {
    return Objects.hash(language, text, texts, origin, detectLanguage, summarizationDegree);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("language", "text", "texts", "origin", "detectLanguage", "summarizationDegree"));
