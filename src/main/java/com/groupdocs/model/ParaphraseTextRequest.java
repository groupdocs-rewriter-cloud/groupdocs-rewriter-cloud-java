...
public class ParaphraseTextRequest {
  ...
  public ParaphraseTextRequest detectLanguage(@javax.annotation.Nullable Boolean detectLanguage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, paraphraseTextRequest.language) &&
        ...
        Objects.equals(this.detectLanguage, paraphraseTextRequest.detectLanguage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(language, text, texts, origin, detectLanguage, suggestions, diversityDegree, tokenize);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("language", "text", "texts", "origin", "detectLanguage", "suggestions", "diversityDegree", "tokenize"));
