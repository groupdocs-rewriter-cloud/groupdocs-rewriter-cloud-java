...
public class ParaphraseFileResponse {
  ...
  public ParaphraseFileResponse status(@javax.annotation.Nullable HttpStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  public ParaphraseFileResponse message(@javax.annotation.Nullable String message) {
  ...
  public ParaphraseFileResponse url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
