...
public class SynonymizeTextResponse {
  ...
  public SynonymizeTextResponse status(@javax.annotation.Nullable HttpStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  public SynonymizeTextResponse message(@javax.annotation.Nullable String message) {
  ...
  public SynonymizeTextResponse synonymizerResults(@javax.annotation.Nullable List<String> synonymizerResults) {
  ...
  public void setSynonymizerResults(@javax.annotation.Nullable List<String> synonymizerResults) {
    this.synonymizerResults = synonymizerResults;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "message", "synonymizerResults"));
