...
public class ParaphraseTextResponse {
  ...
  public ParaphraseTextResponse status(@javax.annotation.Nullable HttpStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  public ParaphraseTextResponse message(@javax.annotation.Nullable String message) {
  ...
  public ParaphraseTextResponse paraphraseReult(@javax.annotation.Nullable String paraphraseReult) {
  ...
  public void setParaphraseReult(@javax.annotation.Nullable String paraphraseReult) {
    this.paraphraseReult = paraphraseReult;
  }


  public ParaphraseTextResponse paraphraseResults(@javax.annotation.Nullable List<String> paraphraseResults) {
  ...
  public void setParaphraseResults(@javax.annotation.Nullable List<String> paraphraseResults) {
    this.paraphraseResults = paraphraseResults;
  }


  public ParaphraseTextResponse sourceList(@javax.annotation.Nullable List<String> sourceList) {
  ...
  public void setSourceList(@javax.annotation.Nullable List<String> sourceList) {
    this.sourceList = sourceList;
  }


  public ParaphraseTextResponse targetList(@javax.annotation.Nullable List<String> targetList) {
  ...
  public void setTargetList(@javax.annotation.Nullable List<String> targetList) {
    this.targetList = targetList;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "message", "paraphraseReult", "paraphraseResults", "sourceList", "targetList"));
