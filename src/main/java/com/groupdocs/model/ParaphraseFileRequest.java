...
public class ParaphraseFileRequest {
  ...
  public ParaphraseFileRequest detectLanguage(@javax.annotation.Nullable Boolean detectLanguage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.language, paraphraseFileRequest.language) &&
        ...
        Objects.equals(this.detectLanguage, paraphraseFileRequest.detectLanguage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(language, url, origin, originalName, savingMode, outputFormat, diversityDegree, format, detectLanguage);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("language", "url", "origin", "originalName", "savingMode", "outputFormat", "diversityDegree", "format", "detectLanguage"));
