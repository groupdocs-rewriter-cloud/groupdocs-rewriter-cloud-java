...
public class CloudTextRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(language, handler, text, action, jobofferurl, cvurl, coverletterurl, texts, suggestions, diversity, tokenize, origin, originaltext, alternativetext, requestId, userEmail);
  }
