...
public class Model {
  ...
  public Model loaded(@javax.annotation.Nullable Boolean loaded) {
    this.loaded = loaded;
    return this;
  }
  ...
  public void setLoaded(@javax.annotation.Nullable Boolean loaded) {
    this.loaded = loaded;
  }


  public Model modelsId(@javax.annotation.Nullable Integer modelsId) {
  ...
  public void setModelsId(@javax.annotation.Nullable Integer modelsId) {
    this.modelsId = modelsId;
  }


  public Model models(@javax.annotation.Nullable List<String> models) {
    this.models = models;
    return this;
  }
  ...
  public Model opt(@javax.annotation.Nullable Opt opt) {
    this.opt = opt;
    return this;
  }
  ...
  public void setOpt(@javax.annotation.Nullable Opt opt) {
    this.opt = opt;
  }


  public Model timeout(@javax.annotation.Nullable Integer timeout) {
  ...
  public Model tokenizer(@javax.annotation.Nullable Tokenizer tokenizer) {
  ...
  public void setTokenizer(@javax.annotation.Nullable Tokenizer tokenizer) {
    this.tokenizer = tokenizer;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("loaded", "models_id", "models", "opt", "timeout", "tokenizer"));
