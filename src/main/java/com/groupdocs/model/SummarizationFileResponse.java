...
public class SummarizationFileResponse {
  ...
  public SummarizationFileResponse status(@javax.annotation.Nullable HttpStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  public SummarizationFileResponse message(@javax.annotation.Nullable String message) {
  ...
  public SummarizationFileResponse url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "message", "url"));
