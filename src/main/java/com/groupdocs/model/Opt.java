...
public class Opt {
  ...
  public Opt beamSize(@javax.annotation.Nullable Integer beamSize) {
  ...
  public void setBeamSize(@javax.annotation.Nullable Integer beamSize) {
    this.beamSize = beamSize;
  }


  public Opt gpu(@javax.annotation.Nullable Integer gpu) {
    this.gpu = gpu;
    return this;
  }
  ...
  public Opt replaceUnk(@javax.annotation.Nullable Boolean replaceUnk) {
  ...
  public void setReplaceUnk(@javax.annotation.Nullable Boolean replaceUnk) {
    this.replaceUnk = replaceUnk;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("beam_size", "gpu", "replace_unk"));
