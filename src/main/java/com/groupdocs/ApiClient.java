...
public class ApiClient {
    ...
    private String basePath = "https://api.groupdocs.cloud/v2.0/rewriter";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.groupdocs.cloud/v2.0/rewriter",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/25.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.groupdocs.cloud/v2.0/rewriter
